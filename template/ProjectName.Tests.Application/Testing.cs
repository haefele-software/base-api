...
namespace ProjectName.Application.Integration.Tests
{
    ...
    public class Testing
    {
        ...
        {
            return await RunAsUserAsync("test@local", "Testing1234!", new string[] { }).ConfigureAwait(false);
        }

        public static async Task<string> RunAsAdministratorAsync()
        {
            return await RunAsUserAsync("administrator@local", "Administrator1234!", new[] { "Administrator" }).ConfigureAwait(false);
        }
        ...
        {
            await _checkpoint.Reset(_configuration.GetConnectionString("DefaultConnection")).ConfigureAwait(false);
            _currentUserId = null;
        }
